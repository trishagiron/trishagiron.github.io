...
(this,function(t,e){
            ...
            ,s.hide=function(){
                ...
                if(!this._isTransitioning&&t(this._element).hasClass(h)){
                    ...
                    if(t(this._element).trigger(n),!n.isDefaultPrevented()){
                        ...
                        if(this._element.style[i]=this._element.getBoundingClientRect()[i]+"px",k.reflow(this._element),t(this._element).addClass(u).removeClass(f).removeClass(h),this._triggerArray.length>0)for(var r=0;
    ...
    W<H.length;
    W+=1)if(j&&navigator.userAgent.indexOf(H[W])>=0){
        M=1;
        break
    }
            ...
            ,flip:{
                order:600,enabled:!0,fn:function(t,e){
                    ...
                    switch(e.behavior){
                        case At.FLIP:s=[i,r];
                        break;
                        case At.CLOCKWISE:s=It(i);
                        break;
                        case At.COUNTERCLOCKWISE:s=It(i,!0);
                        break;
                        default:s=e.behavior
                    }
    ...
    var Nt=function(t){
        ...
        ,N=function(){
            ...
            ,s._clearMenus=function(e){
                if(!e||3!==e.which&&("keyup"!==e.type||9===e.which))for(var i=t.makeArray(t(_)),r=0;
                r<i.length;
                r++){
